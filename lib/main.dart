      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            FlatButton(
              child: Text("用普通路由跳转到RandomWords页面"),
              textColor: Colors.blue,
              onPressed: () {
                Navigator.push(context,
                    new MaterialPageRoute(builder: (context) {
                  return RandomWordsWidget("廖鹏辉233");
                }));
              },
            ),
            FlatButton(
...
class MyButton extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return new GestureDetector(
      onTap: (){
        print("taptaptaptaptaptaptaptaptap");
      },
      child: new Container(
        height: 100,
        ...
        child: new Center(
          child: new Text("2333333333333333333333333"),
        ),
      ),
    );
  }
